...
DEFAULT_DOCUMENTS = [
    {
        "id": "numax_intro",
        "text": "NUMAX is a governed agentic cortex designed to transform "
        "intent into structured artifacts.",
    },
    {
        "id": "numax_memory",
        "text": "NUMAX includes working memory, episodic memory, semantic memory "
        "and continuity mechanisms.",
    },
    {
        "id": "numax_runtime",
        "text": "NUMAX uses runtime policies, model routing, budget guards "
